...
//                            "</form>";
    ...
    public List<Request> searchRequestsByType(String key) {

        List<Request> requestList = new ArrayList<>();

        for (RequestEntity requestEntity : requestRepository.findByRequestTypeEntityName(key)) {
            requestList.add(requestEntityToRequest.convert(requestEntity));
        }
