...
public class UserService {
    ...
    public void deleteUserFollowId(int id) {
        ...
        //delete payroll of user
        for (DatePayrollDetailEntity datePayrollDetailEntity : dateDetailPayrollRepository.findByUserEntityId(id)) {
            dateDetailPayrollRepository.delete(datePayrollDetailEntity);
        }
